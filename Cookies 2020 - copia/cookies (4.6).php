...
//COOKIES DE TERCEROS
	$vis_twitter = 1; // Compartir en twitter
	$vis_google_maps = 0; // Mostrar mapa de googlemaps
	$vis_google_capt = 1; // Uso de recaptcha de google
...
<div class="w-100 fixed-bottom bg-secondary txt-cookies">
	...
	?>
	<div id="cookies_ocu" class="<?=$disp?> bg-white">
		...
		<div class="col-lg-12 border-bottom">
			<p class="mb-1 pt-2">
				Las cookies que puede utilizar <b><?=$url_web?></b>:
				<br>
		...
		<form id="form_cookies" class="col-lg-12 pb-2 border-bottom" method="POST" action="javascript:form_cookies();">
			<div class="row">
				...
				<div class="form-check form-check-inline mb-0 d-flex align-items-center col-lg-auto col-12 mt-1 p-2">
					...
					<input id="coo_ana" class="form-check-input h-100" type="checkbox" value="1" name="coo_ana" <?=$checked?>>
				...
				<div class="form-check form-check-inline mb-0 d-flex align-items-center col-lg-auto col-12 mt-1 p-2">
					...
					<input id="coo_ter" class="form-check-input h-100" type="checkbox" value="1" name="coo_ter" <?=$checked?>>
					<label class="form-check-label">
						De terceros
					</label>
				</div>
			...
			<div class="form-check">
				<ul class="nav nav-tabs" id="myTab" role="tablist">
					...
					<li class="nav-item dropdown">
						<a class="nav-link" id="ana-tab" data-toggle="tab" href="#ana" role="tab" aria-controls="ana" aria-selected="false">Analíticas</a>
					</li>
					<?
					}
					if($tot_coo_ter == '1'){
				...
				<div class="tab-content" id="myTabContent">
					...
					if($tot_coo_ana == '1'){
					?>
					<div class="tab-pane fade" id="ana" role="tabpanel" aria-labelledby="profile-tab">
						<div class="row">
							<div class="col-lg-12">
								<p class="pt-3">
									<u>INFORMACIÓN:</u>
