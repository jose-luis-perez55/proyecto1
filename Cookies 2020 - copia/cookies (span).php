	...
	<div id="cookies_ocu" class="row-fluid <?=$disp?>">
		...
		<form id="form_cookies" class="span12 d-flex align-items-stretch pb-2 border-bottom" method="POST" action="javascript:form_cookies();">
			...
			<div class="form-check form-check-inline mb-0 d-flex align-items-center float-left">
				...
				<input id="coo_ana" class="form-check-input h-100 float-left" type="checkbox" value="1" name="coo_ana" <?=$checked?>>
			...
			<div class="form-check form-check-inline mb-0 d-flex align-items-center float-left">
				...
				<input id="coo_ter" class="form-check-input h-100 float-left" type="checkbox" value="1" name="coo_ter" <?=$checked?>>
				<label class="form-check-label float-left">
					De terceros
				</label>
			</div>
